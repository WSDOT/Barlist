...
CString CBarlistDocTemplate::GetTemplateGroupItemDescription(const CEAFTemplateItem* pItem) const
{
   CString strDescription(_T("Create a new Barlist project (Reinforcing steel quantities estimates)."));
