...
// Type90.h : Declaration of the CType90
...
/////////////////////////////////////////////////////////////////////////////
// CBendData
class ATL_NO_VTABLE CType90 : 
//	public CComObjectRootEx<CComSingleThreadModel>,
//	public CComCoClass<CType90, &CLSID_Type90>,
   public CBendImpl<CType90,&CLSID_Type90>
{
public:
	CType90() : CBendImpl<CType90, &CLSID_Type90>(90,true,true,true,true,true,true,true)
	{
	}

DECLARE_REGISTRY_RESOURCEID(IDR_TYPE90)

DECLARE_PROTECT_FINAL_CONSTRUCT()

//BEGIN_COM_MAP(CType90)
