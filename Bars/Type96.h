...
// Type96.h : Declaration of the CType96
...
/////////////////////////////////////////////////////////////////////////////
// CBendData
class ATL_NO_VTABLE CType96 : 
//	public CComObjectRootEx<CComSingleThreadModel>,
//	public CComCoClass<CType96, &CLSID_Type96>,
   public CBendImpl<CType96,&CLSID_Type96>
{
public:
	CType96() : CBendImpl<CType96, &CLSID_Type96>(96,true,true,true,true,true,true,true)
	{
	}

DECLARE_REGISTRY_RESOURCEID(IDR_TYPE96)

DECLARE_PROTECT_FINAL_CONSTRUCT()

//BEGIN_COM_MAP(CType96)
