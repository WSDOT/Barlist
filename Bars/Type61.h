...
// Type61.h : Declaration of the CType61
...
/////////////////////////////////////////////////////////////////////////////
// CBendData
class ATL_NO_VTABLE CType61 : 
//	public CComObjectRootEx<CComSingleThreadModel>,
//	public CComCoClass<CType61, &CLSID_Type61>,
   public CBendImpl<CType61,&CLSID_Type61>
{
public:
	CType61() : CBendImpl<CType61, &CLSID_Type61>(61,true,true,true,true,true)
	{
	}

DECLARE_REGISTRY_RESOURCEID(IDR_TYPE61)

DECLARE_PROTECT_FINAL_CONSTRUCT()

//BEGIN_COM_MAP(CType61)
