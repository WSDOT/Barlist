...
// Type91.h : Declaration of the CType91
...
/////////////////////////////////////////////////////////////////////////////
// CBendData
class ATL_NO_VTABLE CType91 : 
//	public CComObjectRootEx<CComSingleThreadModel>,
//	public CComCoClass<CType91, &CLSID_Type91>,
   public CBendImpl<CType91,&CLSID_Type91>
{
public:
	CType91() : CBendImpl<CType91, &CLSID_Type91>(91,true,true,true,true,true,true,true)
	{
	}

DECLARE_REGISTRY_RESOURCEID(IDR_TYPE91)

DECLARE_PROTECT_FINAL_CONSTRUCT()

//BEGIN_COM_MAP(CType91)
