...
// Type99.h : Declaration of the CType99
...
/////////////////////////////////////////////////////////////////////////////
// CBendData
class ATL_NO_VTABLE CType99 : 
//	public CComObjectRootEx<CComSingleThreadModel>,
//	public CComCoClass<CType99, &CLSID_Type99>,
   public CBendImpl<CType99,&CLSID_Type99>
{
public:
	CType99() : CBendImpl<CType99, &CLSID_Type99>(99,true,true,true,true,true,true,true)
	{
	}

DECLARE_REGISTRY_RESOURCEID(IDR_TYPE99)

DECLARE_PROTECT_FINAL_CONSTRUCT()

//BEGIN_COM_MAP(CType99)
