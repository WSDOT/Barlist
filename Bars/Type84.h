...
// Type84.h : Declaration of the CType84
...
/////////////////////////////////////////////////////////////////////////////
// CBendData
class ATL_NO_VTABLE CType84 : 
//	public CComObjectRootEx<CComSingleThreadModel>,
//	public CComCoClass<CType84, &CLSID_Type84>,
   public CBendImpl<CType84,&CLSID_Type84>
{
public:
	CType84() : CBendImpl<CType84, &CLSID_Type84>(84,true,true,true,true,true,true,true)
	{
	}

DECLARE_REGISTRY_RESOURCEID(IDR_TYPE84)

DECLARE_PROTECT_FINAL_CONSTRUCT()

//BEGIN_COM_MAP(CType84)
